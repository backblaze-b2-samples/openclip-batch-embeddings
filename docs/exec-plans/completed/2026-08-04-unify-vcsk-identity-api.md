...
Make OpenCLIP Batch Embeddings the canonical identity across the shipped web app,
...
The web app and local API now ship under the OpenCLIP Batch Embeddings identity.
